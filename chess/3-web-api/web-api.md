...
| Web Page Loads | Test web page properly loads in browser (including all files linked to by the test page: favicon.ico, index.css, index.js)                                                                       | Prerequisite |
| Web API Works  | All pass off test cases in `StandardAPITests.java` succeed                                                                                                                                       |          125 |
| Code Quality   | [Rubric](../code-quality-rubric.md)                                                                                                                                                              |           30 |
| Unit Tests     | Each public method on your **Service classes** has two test cases, one positive test and one negative test | Prerequisite |
| Unit Test Quality | All test cases pass<br/>Every test case includes an Assert statement of some type |           25 |
|                | Total                                                                                                                                                                                            |          180 |
