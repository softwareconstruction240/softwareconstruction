...
⚠ On some operating systems, MySQL treats database and table names as case-sensitive, and on others it does not. To guarantee your code will work on the autograder, assume case-sensitivity even if your machine doesn't require it.
